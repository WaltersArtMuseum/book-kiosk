...
var options = {
  ...
  getPageURI: function (index, reduce, rotate) {
    ...
    var url = 'assets/book/W934_' + leafStr.replace(re, imgStr) + '_sap.jpg'; // edit to match book filenames
    return url;
  },
  ...
  //
  // For example, index 5 might correspond to "Page 1"
  // if there is front matter such as a title page and table of contents.
